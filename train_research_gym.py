...
if __name__ == "__main__":
    ...
    parser.add_argument('--group_name', type=str, default='ToyGymEnvs')
    ...
    print("  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -  -")
    print(f'Scenario: {args.scenario}, {args.name}')
    print("---------------------------------------")
    ...
    group_name = f'{args.group_name}_{args.scenario}'
    ...
    if args.policy == "TD3":
        ...
        kwargs['loss_fn'] = reward_function
        kwargs['ph_coeff'] = args.ph_coeff
        kwargs['transition_fn'] = state_function
